                ...
                children: [
                  IconButton(
                    ...
                    onPressed: () async {
                      ...
                      if (xfile != null) {
                        ...
                        // Route through text input sheet instead of bypassing directly to analysis
                        ref.read(mealScanProvider.notifier).enterTextMode(bytes);
                      }
                    },
                  ),
                  FloatingActionButton(
                    onPressed: !lifecycleState.hasValue ? null : () async {
                      ...
                      // Route through text input sheet instead of bypassing directly to analysis
                      ref.read(mealScanProvider.notifier).state = MealScanCapturingText(imageBytes: bytes);
                    },
